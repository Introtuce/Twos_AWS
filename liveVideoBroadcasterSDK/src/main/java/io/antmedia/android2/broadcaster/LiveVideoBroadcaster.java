package io.antmedia.android2.broadcaster;
...
import io.antmedia.android2.R;
import io.antmedia.android2.broadcaster.encoder.AudioHandler;
import io.antmedia.android2.broadcaster.encoder.CameraSurfaceRenderer;
import io.antmedia.android2.broadcaster.encoder.TextureMovieEncoder;
import io.antmedia.android2.broadcaster.encoder.VideoEncoderCore;
import io.antmedia.android2.broadcaster.network.IMediaMuxer;
import io.antmedia.android2.broadcaster.network.RTMPStreamer;
import io.antmedia.android2.broadcaster.utils.Resolution;
import io.antmedia.android2.broadcaster.utils.Utils;
        ...
        try {
            ...
            if (result) {
                ...
                if (adaptiveStreamingEnabled) {
                    Toast.makeText(getApplicationContext(),"Adaptive Streaming Enabled",Toast.LENGTH_LONG).show();
